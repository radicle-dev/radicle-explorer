...
<style>
  ...
  input:focus:not(.invalid) + .right-container {
    border-top: 1px solid var(--color-surface-brand-primary);
    border-right: 1px solid var(--color-surface-brand-primary);
    border-bottom: 1px solid var(--color-surface-brand-primary);
    color: var(--color-text-primary);
  }
  input:focus:not(.invalid) {
    border: 1px solid var(--color-surface-brand-primary);
  }
  input[disabled] {
    cursor: not-allowed;
  }
