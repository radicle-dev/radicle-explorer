...
<style>
  ...
  .merge {
    /* TODO: Check if this should use a different border color */
    border: 1px solid var(--color-surface-merged);
    background-color: var(--color-surface-merged);
  }
  .positive-review {
    border: 1px solid var(--color-feedback-success-bg);
  ...
  .negative-review {
    border: 1px solid var(--color-feedback-error-bg);
                ...
                <DropdownListItem selected={false}>
                  <span class="compare-dropdown-item">
                    ...
                    <span
                      ...
                      style:font="var(--txt-code-semibold)">
                ...
                <DropdownListItem
                  ...
                  <span class="compare-dropdown-item">
                    Compare to previous revision: <span
                      style:color="var(--color-surface-brand-primary)"
                      style:font="var(--txt-code-semibold)">
      ...
      {#each timelines as element}
        ...
        {:else if element.type === "merge"}
          ...
          <div class="action merge">
            <div class="authorship-header">
              <div style:color="var(--color-surface-brand-primary)">
                <Icon name="patch" />
              </div>
